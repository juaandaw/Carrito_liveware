<div class="container-menu py-8 lg:grid-cols-2 xl:grid-cols-5 gap-6">
            ...
            <div class="bg-white rounded-lg shadow">
                ...
                <div class="px-6 pb-6 grid grid-cols-2 gap-6" :class="{'hidden': envio_type !=2}">
                    ...
                    <div>
                        ...
                        <select class="form-control w-full" name="form-control w-full" wire:model="city_id">
                    ...
                    <div>
                        ...
                        <select class="form-control w-full" name="form-control w-full" wire:model="district_id">
                            <option value="" disabled selected>Seleccione una ciudad</option>
