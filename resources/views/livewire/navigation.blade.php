<header class="bg-trueGray-700 sticky top-0" x-data="dropdown()">
    <div class="container-menu flex items-center h-16 justify-between md:justify-start">
        <a :class="{bg-opacity-100 text-orange-500: open}" x-on:click="show()" class="flex flex-col items-center justify-center order-last md:order-first px-6 sm:px4 bg-white bg-opacity-25 text-white cursor-pointer font-semibold h-full">
...
12h16M4 18h16" />
    ...
    <nav id="navigation-menu" x-show="open" :class="{'block': open, 'hidden': !open}" class="bg-trueGray-700 bg-opacity-25 w-full absolute">
