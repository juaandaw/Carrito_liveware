...
{{$category->name}}
                        ...
                        <td class="py-2">
                            <div class="flex divide-x divide-gray-300 font-semibold">
                                <a class="pr-2 hover:text-blue-600 cursor-pointer mr-0.5" wire:click="edit('{{$category->slug}}')">Editar</a>
    ...
    <x-jet-dialog-modal wire:model="editForm.open">
        ...
        <x-slot name="footer">
            <x-jet-danget-button wire:click="update" wire:loading.attr="disabled" wire:target="editImage,update">
                Actualizar
            </x-jet-danget-button>
        </x-slot>
    </x-jet-dialog-modal>
